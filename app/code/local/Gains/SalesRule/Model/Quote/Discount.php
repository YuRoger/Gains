...
class Gains_SalesRule_Model_Quote_Discount extends Mage_Sales_Model_Quote_Address_Total_Abstract
{

    private $_discountDescArray=array();
   /**
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        foreach ($items as $item) {
            if ($item->getNoDiscount()) {
                ...
                array_push($this->_discountDescArray,$item->getDiscountDesc());
            }
        }
        $address->setDiscountDescriptionArray($this->_discountDescArray);
        /**
