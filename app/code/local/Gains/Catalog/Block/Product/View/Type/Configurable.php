<?php
class Gains_Catalog_Block_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable
{
...
//            'prices'          => $this->_prices,
            ...
            'chooseText'        => Mage::helper('catalog')->__('Please select'),
            'taxConfig'         => $taxConfig
        );
